...
function Calendar({ className, classNames, showOutsideDays = true, ...props }) {
    return (_jsx(DayPicker, { showOutsideDays: showOutsideDays, className: cn("p-3", className), classNames: {
            ...
            cell: cn("relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-zinc-100 [&:has([aria-selected].day-outside)]:bg-zinc-100/50 [&:has([aria-selected].day-range-end)]:rounded-r-md dark:[&:has([aria-selected])]:bg-zinc-800 dark:[&:has([aria-selected].day-outside)]:bg-zinc-800/50", props.mode === "range"
            ...
            day_outside: "day-outside text-zinc-500 aria-selected:bg-zinc-100/50 aria-selected:text-zinc-500 dark:text-zinc-400 dark:aria-selected:bg-zinc-800/50 dark:aria-selected:text-zinc-400",
            ...
            // @ts-ignore - The react-day-picker types don't match the actual API
            IconLeft: ({ ...props }) => (_jsx(ChevronLeft, { className: cn("h-4 w-4"), ...props })),
            // @ts-ignore - The react-day-picker types don't match the actual API
            IconRight: ({ ...props }) => (_jsx(ChevronRight, { className: cn("h-4 w-4"), ...props })),
        }, ...props }));
}
