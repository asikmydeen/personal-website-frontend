...
const Card = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("rounded-xl shadow bg-muted border border-muted-border text-muted-foreground", className), ...props })));
