    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <motion.div
            className={`fixed z-50 bg-white dark:bg-gray-800 shadow-xl ${drawerClassName}`}
          ...
          >
            <div className={`h-full overflow-auto p-4 ${className}`}>
              {closeButton && (
                <motion.button
                  className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center text-gray-600 dark:text-gray-300 focus:outline-none"
