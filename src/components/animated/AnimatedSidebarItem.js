...
const AnimatedSidebarItem = ({ to, icon, label, isActive, collapsed, onClick }) => {
    ...
    return (_jsx(Link, { to: to, style: {
            ...
            borderRadius: '6px',
            margin: '6px 0',
        }, onClick: onClick, children: _jsxs(motion.div, { style: {
                display: 'flex',
                alignItems: 'center',
                width: '100%',
                padding: '8px',
                ...
                position: 'relative',
                overflow: 'hidden'
            }, whileHover: "hover", whileTap: "tap", animate: isActive ? "active" : undefined, variants: itemAnimation, children: [_jsx(motion.div, { style: {
                        marginRight: collapsed ? 0 : 12,
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        fontSize: collapsed ? '20px' : '18px',
                    }, variants: iconAnimation, animate: iconAnimation.animate, whileHover: iconAnimation.hover, children: _jsx("span", { role: "img", "aria-label": label, children: icon }) }), !collapsed && (_jsx(motion.span, { style: {
                        fontSize: '16px',
                        fontWeight: isActive ? 'bold' : 'normal',
                    }, initial: { opacity: 0, x: -5 }, animate: { opacity: 1, x: 0 }, transition: { duration: 0.2 }, children: label })), isActive && (_jsx(motion.div, { style: {
                        position: 'absolute',
                        left: 0,
                        bottom: 0,
                        height: 3,
                    ...
                    }, layoutId: "activeIndicator", transition: { duration: 0.3 } }))] }) }));
};
